...
export type ISuggestList = (ISuggestListItem<Song> & ISuggestListItem<Artist> & ISuggestListItem<Album> & ISuggestListItem<Playlist>)[]
...
export const useUpdateSearchHistoryList = () => useSearchStore(state => state.updateSearchHistoryList)
