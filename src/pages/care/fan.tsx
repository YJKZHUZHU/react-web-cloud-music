...
import {userFolloweds, Followed} from "@/api/care"
...
export default function () {
  ...
  const getList = async () => {
    try {
      setLoading(true)
      const res = await userFolloweds({
        uid: uid!,
        ...pageRef.current
      })
      setList([...list, ...res.data.followeds])
  ...
  return (
    <Flex
      ...
      <span className="text-[18px] text-[#262627] font-bold">{nickName}的粉丝</span>
