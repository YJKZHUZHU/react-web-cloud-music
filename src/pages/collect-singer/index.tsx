...
export default function () {
  ...
  const virtualListHeight = useVirtualListHeight(65)
  ...
  return (
    <Layout gap={16} loading={loading} empty={data.length === 0 && !loading} desc="暂无收藏的歌手">
      <Flex align="center" gap={2}>
        <span className="text-[#272728] font-bold">收藏的歌手</span>
